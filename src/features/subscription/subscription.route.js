...
router.post(
  ...
  subscriptionValidation.createSubscriptionValidation,
  subscriptionController.createSubscriptionController,
);
router.get(
  "/:id",
  authMiddleware(["admin", "ops"]),
  subscriptionValidation.paramsIdValidation,
...
router.put(
  "/:id/verify",
  authMiddleware(["admin", "ops"]),
  subscriptionValidation.verifySubscriptionValidation,
  subscriptionController.verifySubscription,
);
router.put(
  "/:id/cancel",
  authMiddleware(["admin", "ops"]),
  subscriptionValidation.cancelSubscriptionValidation,
