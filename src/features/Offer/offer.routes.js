...
router.get(
  "/category/:category",
  offerValidation.categoryValidationRules(),
  offerController.getOffer,
);
router.get(
  "/:id",
  offerValidation.idValidationRules(),
...
router.post(
  ...
  offerValidation.createOfferValidationRules(),
  offerController.createOffer,
);
router.put(
  "/:id",
  authMiddleware(["admin", "ops"]),
  offerValidation.updateOfferValidationRules(),
