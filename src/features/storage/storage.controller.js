...
import { S3_FOLDERS, PRESIGN_EXPIRY_SECONDS } from "../../config/storage/s3.constants.js";
import { ok, created, internalError, badRequest } from "../../utils/response.js";
...
export const getPresignedUrl = async (req, res) => {
  try {
    ...
    if (!Object.values(S3_FOLDERS).includes(folder))
      return badRequest(res, `Invalid folder. Allowed: ${Object.values(S3_FOLDERS).join(", ")}`);
